...
import com.mindhub.homebanking.services.EmailServiceReceipt;
...
public class TransactionController {
    ...
    @Autowired
    EmailServiceReceipt emailServiceReceipt;
    ...
    public ResponseEntity<Object> makeTransaction(
        ...
        if (amount.isNaN() || description.isEmpty() || fromAccountNumber.isEmpty() || toAccountNumber.isEmpty() ||
            ...
            emailServiceReceipt.sendMail(client, fromAccountNumber, toAccountNumber, amount, description);

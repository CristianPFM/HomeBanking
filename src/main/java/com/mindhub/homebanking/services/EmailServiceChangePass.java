...
public class EmailServiceChangePass {
    ...
    public void sendMail(String email, String firstName, String temporalPass) throws MessagingException {
        ...
        helper.setSubject("Solicitud para cambio de contraseña - " + firstName);
        ...
        String html = "<!DOCTYPE html>\n" +
                ...
                "                </div>\n" +
                "                <h1 style=\"margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;text-align:center;\">Contraseña temporal</h1>\n" +
                "                <p style=\"margin:0;text-align:center;\">Hola <b style='text-transform: capitalize;'>"+ firstName +"</b>, recientemente has solicitado cambiar o recuperar tu contraseña de Ecobank.</p>\n" +
                "              </td>\n" +
                "            </tr>\n" +
                "            <tr>\n" +
                ...
                "                  <p style=\"margin-top:0;margin-bottom:12px;\">Para poder recuperar/cambiar tu contraseña debes ingresar la <b>contraseña temporal</b> que se muestra a continuación.</p>\n" +
                ...
                "                      <!--[if mso]><i style=\"letter-spacing: 25px;mso-font-width:-100%;mso-text-raise:20pt\">&nbsp;</i><![endif]--><span style=\"mso-text-raise:10pt;font-weight:bold;\">"+temporalPass+"</span>\n" +
